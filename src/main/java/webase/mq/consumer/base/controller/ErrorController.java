 ...
 * the License.
 */
package webase.mq.consumer.base.controller;
...
public class ErrorController extends BasicErrorController {
    ...
    public ResponseEntity<Map<String, Object>> error(HttpServletRequest request) {
        ...
        if (index > 0) {
            ...
            throw new MqException(Integer.valueOf(code), msg);
        } else {
            throw new MqException(ConstantCode.SYSTEM_EXCEPTION.getCode(), mesage);
        }
    }
